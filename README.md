...
* There is a payment options component that allows you to define different packages or levels for people to purchase/support at.  You can turn it on and off with a configuration setting.
